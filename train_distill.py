...
def parse_opt(known=False):
    ...
    parser.add_argument('--teacher_weights', type=str, default='yolov5s.pt', help='initial weights path (teacher)')
    parser.add_argument('--teacher_cfg', type=str, default='yolov5s.yaml', help='initial model.yaml path (teacher)')
